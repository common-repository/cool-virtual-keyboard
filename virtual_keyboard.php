<?php
/*
Plugin Name: Cool Virtual Keyboard
Plugin URI: 
Description: This plugin adds virtual keyboard for all text inputs and textareas on your site.
Version: 0.21
Author: Oleg Yevik
Author e-mail: oleg.yevik@gmail.com
*/
...
<div class="wrap">
	...
	<fieldset class="options">
		<legend>Language layout:</legend>
		<?php
		$CVK_virtkeyboard_layout = get_option('CVK_virtkeyboard_layout');
		?>
			<select name="CVK_virtkeyboard_layout">
				<option value="ar"<?php if($CVK_virtkeyboard_layout == 'ar'){ echo(' selected="selected"');}?>>Arabic</option>
				<option value="cn"<?php if($CVK_virtkeyboard_layout == 'cn'){ echo(' selected="selected"');}?>>Chinese</option>
                <option value="en"<?php if($CVK_virtkeyboard_layout == 'en' OR $CVK_virtkeyboard_layout == ''){ echo(' selected="selected"');}?>>English</option> 
				<option value="fr"<?php if($CVK_virtkeyboard_layout == 'fr'){ echo(' selected="selected"');}?>>French</option>
				<option value="ge"<?php if($CVK_virtkeyboard_layout == 'ge'){ echo(' selected="selected"');}?>>German</option>
				<option value="gr"<?php if($CVK_virtkeyboard_layout == 'gr'){ echo(' selected="selected"');}?>>Greek</option>
				<option value="hb"<?php if($CVK_virtkeyboard_layout == 'hb'){ echo(' selected="selected"');}?>>Hebrew</option>
				<option value="jp"<?php if($CVK_virtkeyboard_layout == 'jp'){ echo(' selected="selected"');}?>>Japanese</option>
				<option value="ko"<?php if($CVK_virtkeyboard_layout == 'ko'){ echo(' selected="selected"');}?>>Korean</option>
				<option value="ku"<?php if($CVK_virtkeyboard_layout == 'ku'){ echo(' selected="selected"');}?>>Kurdish</option>
				<option value="ru"<?php if($CVK_virtkeyboard_layout == 'ru'){ echo(' selected="selected"');}?>>Russian</option>
				<option value="sp"<?php if($CVK_virtkeyboard_layout == 'sp'){ echo(' selected="selected"');}?>>Spanish</option>
				<option value="ta"<?php if($CVK_virtkeyboard_layout == 'ta'){ echo(' selected="selected"');}?>>Tamil</option>
				<option value="th"<?php if($CVK_virtkeyboard_layout == 'th'){ echo(' selected="selected"');}?>>Thai</option>
				<option value="ur"<?php if($CVK_virtkeyboard_layout == 'ur'){ echo(' selected="selected"');}?>>Urdu</option>
			</select>
...
function CVK_register_virtual_keyboard_styles() {
	wp_register_style('virtual-keyboard-plugin', plugins_url('cool-virtual-keyboard/css/virt-keyboard-style.css' ) );
...
function CVK_register_virtual_keyboard_scripts() {
	wp_enqueue_script(
		'custom-script',
		plugins_url('cool-virtual-keyboard/js/virtual-keyboard.js' ),
		array('jquery')
	);
}
...
function CVK_add_virtual_keyboard_html() {
    ...
    switch ($CVK_virtkeyboard_layout) { // case '' - return english layout
        case "ar": echo '<script> var CVK_langStringArray = {
    name: "Arabic", keys: [
      ["\u0630", "\u0651", ""], ["1", "!", "\u00a1", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a4"], ["5", "%", "\u20ac"], ["6", "^", "\u00bc"], ["7", "&", "\u00bd"], ["8", "*", "\u00be"], ["9", "(", "\u2018"], ["0", ")", "\u2019"], ["-", "_", "\u00a5"], ["=", "+", "\u00d7"],
      ["\u0040", "\u0040", "\u0040"], ["\u0636", "\u064e", ""], ["\u0635", "\u064b", ""], ["\u062b", "\u064f", ""], ["\u0642", "\u064c", ""], ["\u0641", "\u0644", ""], ["\u063a", "\u0625", ""], ["\u0639", "\u2018", ""], ["\u0647", "\u00f7", ""], ["\u062e", "\u00d7", ""], ["\u062d", "\u061b", ""], ["\u062c", "<", ""], ["\u062f", ">", ""], ["\u005C", "|", ""], ["", "\u00a3", ""],
      ["\u0634", "\u0650", ""], ["\u0633", "\u064d", ""], ["\u064a", "]", ""], ["\u0628", "[", ""], ["\u0644", "\u0644", ""], ["\u0627", "\u0623", ""], ["\u062a", "\u0640", ""], ["\u0646", "\u060c", ""], ["\u0645", "\u002F", ""], ["\u0643", ":", ""], ["\u0637", "", ""], ["", "", ""],
      ["\u0626", "~", ""], ["\u0621", "\u0652", ""], ["\u0624", "}", ""], ["\u0631", "{", ""], ["\u0644", "\u0644", ""], ["\u0649", "\u0622", ""], ["\u0629", "\u2019", ""], ["\u0648", ",", ""], ["\u0632", ".", ""], ["\u0638", "\u061f", ""], ["", "", ""]
    ], link: "http://loderi.com/arabic-virtual-keyboard-online" };</script>';
         $CVK_additionals_text = "Arabic";
         $CVK_additionals_url = "http://loderi.com/arabic-virtual-keyboard-online";   
            break;
        case "cn": echo '<script> var CVK_langStringArray = {
    name: "Chinese", keys: [
      ["\u2018", "~", "\u00B0"], ["1", "!", "\u00B1"], ["2", "@", "\u00BC"], ["3", "#", "\u00BD"], ["4", "$", "\u00BE"], ["5", "%", "\u00A4"], ["6", "^", "\u00AC"], ["7", "&", "\u00B2"], ["8", "*", "\u00B3"], ["9", ")", "\u00A2"], ["0", "(", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u20BD"],
      ["\u0040", "\u0040", "\u0040"], ["\u624B", "q", "\u007E"], ["\u7530", "w", "\u00A7"], ["\u6C34", "e", "\u00B6"], ["\u53E3", "r", ":"], ["\u5EFF", "t", ";"], ["\u535C", "y", ""], ["\u5C71", "u", "\u0027"], ["\u6208", "i", "\u0022"], ["\u4EBA", "o", "\u00AB"], ["\u5FC3", "p", "\u00BB"], ["[", "{", "\u005B"], ["]", "}", "\u005D"], ["\u005C", "|", "\u007B"], ["\u002F", "", "\u007D"],
      ["\u65E5", "a", "\u00B5"], ["\u5C38", "s", ""], ["\u6728", "d", ""], ["\u706B", "f", ""], ["\u571F", "g", "\u02BB"], ["\u7AF9", "h", "\u02BC"], ["\u5341", "j", "„"], ["\u5927", "k", "\u201E"], ["\u4E2D", "l", "\u201C"], [";", ":", ""], ["", "", "!"], ["", "", "?"],
      ["\uFF3A", "z", ""], ["\u96E3", "x", ""], ["\u91D1", "c", ""], ["\u5973", "v", ""], ["\u6708", "b", "\u003C"], ["\u5F13", "n", "\u003E"], ["\u4E00", "m", "\u005F"], [",", "<", "\u035F"], [".", ">", "\u005C"], ["", "?", "\u007C"], ["", "", "\u002F"], ["", ""]
    ], link: "http://loderi.com/chinese-virtual-keyboard-online" };</script>';
            $CVK_additionals_text = "Chinese";
            $CVK_additionals_url = "ttp://loderi.com/chinese-virtual-keyboard-online";
            break;            
        case "en": echo '<script> var CVK_langStringArray = {
    name: "English", keys: [ 
      ["\u2018", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "%", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "*", "\u00B3"], ["9", "(", "\u00A2"], ["0", ")", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u20BD"], 
      ...
      ["z", "Z", ""], ["x", "X", ""], ["c", "C", ""], ["v", "V", ""], ["b", "B", "\u003C"], ["n", "N", "\u003E"], ["m", "M", "\u005F"], [",", "\u003C", "\u035F"], [".", "\u003E", "\u005C"], [":", ";", "\u007C"], ["\u002F", "\u005F", "\u002F"]
            ...
            $CVK_additionals_url = "http://loderi.com/english-virtual-keyboard-online";
            break;
        case "fr": echo '<script> var CVK_langStringArray = {
    name: "French", keys: [
     ["\u2018", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "%", "\u00A4"], ["6", "?", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "*", "\u00B3"], ["9", "(", "\u00A2"], ["0", ")", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u00B5"], 
      ...
      ["a", "A", "", "\u00E2", "\u00C2", "", "", "\u00E0", "\u00C0"], ["s", "S", ""], ["d", "D", ""], ["f", "F", ""], ["g", "G", "\u02BB"], ["h", "H", "\u02BC"], ["j", "J", "„"], ["k", "K", "\u201E"], ["l", "L", "\u201C"], [";", ":", ""], ["\u0060", "\u0060", "!", "\u0060", "\u0060", "\u0060", "\u0060", "\u0060", "\u0060"], ["\u0027", "\u0022", "?"],
       ["z", "Z", ""], ["x", "X", ""], ["c", "C", ""], ["v", "V", ""], ["b", "B", "\u003C"], ["n", "N", "\u003E"], ["m", "M", "\u005F"], [",", "\u003C", "\u035F"], [".", "\u003E", "\u005C"], ["\u00E7", "\u00C7", "\u007C"], ["\u0153", "\u0152", "\u002F"]
    ], link: "http://loderi.com/french-virtual-keyboard-online" };</script>';
            ...
            $CVK_additionals_url = "http://loderi.com/french-virtual-keyboard-online";
            break;            
        case "ge": echo '<script> var CVK_langStringArray = {
    name: "Germany", keys: [ 
        ["\u0027", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "\u0025", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "\u002A", "\u00B3"], ["9", "\u0028", "\u00A2"], ["0", "\u0029", "\u20AC"], ["-", "\u005F", "\u00A3"], ["=", "+", "\u00B5"],
        ...
        ], link: "http://loderi.com/german-virtual-keyboard-online" };</script>';
            $CVK_additionals_text = "Germany";
            $CVK_additionals_url = "ttp://loderi.com/german-virtual-keyboard-online";
            break;       
        case "gr": echo '<script> var CVK_langStringArray = {
    name: "Greek", keys: [
      ["`", "~", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "\u0025", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "\u002A", "\u00B3"], ["9", "\u0028", "\u00A2"], ["0", "\u0029", "\u20AC"], ["-", "\u005F", "\u00A3"], ["=", "+", "\u00B5"],
    ...
    ], link: "http://loderi.com/greek-virtual-keyboard-online" };</script>';
            $CVK_optional1 = "CVK_optional-button1";
            $CVK_optional2 = "CVK_optional-button2";
            $CVK_optional3 = "CVK_optional-button3";   
            $CVK_additionals_text = "Greek";
            $CVK_additionals_url = "http://loderi.com/greek-virtual-keyboard-online";
            break;       
        case "hb": echo '<script> var CVK_langStringArray = {
    name: "Hebrew", keys: [
      ["\u2018", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "%", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "*", "\u00B3"], ["9", "(", "\u00A2"], ["0", ")", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u20BD"], 
      ...
      ["\u05d6", "Z"], ["\u05e1", "X"], ["\u05d1", "C"], ["\u05d4", "V"], ["\u05e0", "B"], ["\u05de", "N"], ["\u05e6", "M"], ["\u05ea", ">"], ["\u05e5", "<"], [".", "?"], [], [], []
            ...
            $CVK_additionals_url = "http://loderi.com/hebrew-virtual-keyboard-online";
            break;     
        case "jp": echo '<script> var CVK_langStringArray = {
    name: "Japanese", keys: [
      ...
      ["\u3064", "\u30c4"], ["\u3055", "\u30b5"], ["\u305d", "\u30bd"], ["\u3072", "\u30d2"], ["\u3053", "\u30b3"], ["\u307f", "\u30df"], ["\u3082", "\u30e2"], ["\u306d", "\u30cd", "\u3001", "\uff1c"], ["\u308b", "\u30eb", "\u3002", "\uff1e"], ["\u3081", "\u30e1", "\u30fb", "\uff1f"], ["\u308d", "\u30ed", "", "\uff3f"], [], [], [], []
            ...
            $CVK_additionals_url = "http://loderi.com/japanese-virtual-keyboard-online";
            break;            
        case "ko": echo '<script> var CVK_langStringArray = {
    name: "Korean", keys: [
    ...
    ], link: "http://loderi.com/korean-virtual-keyboard-online" };</script>';
            $CVK_additionals_text = "Korean";
            $CVK_additionals_url = "http://loderi.com/korean-virtual-keyboard-online";
            break;
        case "ku": echo '<script> var CVK_langStringArray = {
    name: "Kurdish", keys: [
      ["\u20ac", "~"], ["\u0661", "!"], ["\u0662", "@"], ["\u0663", "#"], ["\u0664", "$"], ["\u0665", "%"], ["\u0666", "^"], ["\u0667", "&"], ["\u0668", "*"], ["\u0669", "("], ["\u0660", ")"], ["-", "_"], ["=", "+"],
      ["\u0040", "\u0040", "\u0040"], ["\u0642", "`"], ["\u0648", "\u0648\u0648"], ["\u06d5", "\u064a"], ["\u0631", "\u0695"], ["\u062a", "\u0637"], ["\u06cc", "\u06ce"], ["\u0626", "\u0621"], ["\u062d", "\u0639"], ["\u06c6", "\u0624"], ["\u067e", "\u062b"], ["[", "{"], ["]", "}"], ["\u005C", "|"], [],
      ["\u0627", "\u0622"], ["\u0633", "\u0634"], ["\u062f", "\u0630"], ["\u0641", "\u0625"], ["\u06af", "\u063a"], ["\u0647", "\u200c"], ["\u0698", "\u0623"], ["\u06a9", "\u0643"], ["\u0644", "\u06b5"], ["\u061b", ":"], ["\u0027"], [],
      ["\u0632", "\u0636"], ["\u062e", "\u0635"], ["\u062c", "\u0686"], ["\u06a4", "\u0638"], ["\u0628", "\u0649"], ["\u0646", "\u0629"], ["\u0645", "\u0640"], ["\u060c", "<"], [".", ">"], ["\u002F", "\u061f"], [], [], [], []
    ], link: "http://loderi.com/kurdish-virtual-keyboard-online" };</script>';
            $CVK_additionals_text = "Kurdish";
            $CVK_additionals_url = "http://loderi.com/kurdish-virtual-keyboard-online";
            break;            
        case "ru": echo '<script> var CVK_langStringArray = {
    name: "Russian", keys: [
      ...
      ["\u044F", "\u042F", ""], ["\u0447", "\u0427", ""], ["\u0441", "\u0421", ""], ["\u043C", "\u041C", ""], ["\u0438", "\u0418", "\u003C"], ["\u0442", "\u0422", "\u003E"], ["\u044C", "\u042C", "\u005F"], ["\u0431", "\u0411", "\u035F"], ["\u044E", "\u042E", "\u005C"], [",", ";", "\u007C"], [".", ":", "\u002F"]
            ...
            $CVK_additionals_url = "http://loderi.com/russian-virtual-keyboard-online";
            break;  
        case "sp": echo '<script> var CVK_langStringArray = {
    name: "Spanish", keys: [
      ["\u2018", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "%", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "*", "\u00B3"], ["9", "(", "\u00A2"], ["0", ")", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u20BD"], 
    ...
    ], link: "http://loderi.com/spanish-virtual-keyboard-online" };</script>';
            $CVK_optional2 = "CVK_optional-button2";  
            $CVK_additionals_text = "Spanish";
            $CVK_additionals_url = "http://loderi.com/spanish-virtual-keyboard-online";
            break;       
        case "ta": echo '<script> var CVK_langStringArray = {
    name: "Tamil", keys: [
     ...
     ["\u0040", "\u0040", "\u0040"], ["\u0BCC", "\u0B94"], ["\u0BC8", "\u0B90"], ["\u0BBE", "\u0B86"], ["\u0BC0", "\u0B88"], ["\u0BC2", "\u0B8A"], ["\u0BAA", "\u0BAA"], ["\u0BB9", "\u0B99"], ["\u0B95", "\u0B95"], ["\u0BA4", "\u0BA4"], ["\u0B9C", "\u0B9A"], ["\u0B9F", "\u0B9F"], ["\u0B9E"], [], [],
      ...
      ], link: "http://loderi.com/tamil-virtual-keyboard-online" };</script>';
            $CVK_additionals_text = "Tamil";
            $CVK_additionals_url = "http://loderi.com/tamil-virtual-keyboard-online";
            break;       
        case "th": echo '<script> var CVK_langStringArray = {
    name: "Thai", keys: [
    ...
    ], link: "http://loderi.com/thai-virtual-keyboard-online" };</script>';   
            $CVK_additionals_text = "Thai";
            $CVK_additionals_url = "http://loderi.com/thai-virtual-keyboard-online";
            break;       
        case "ur": echo '<script> var CVK_langStringArray = {
    name: "Urdu", keys: [
    ...
    ], link: "http://loderi.com/urdu-virtual-keyboard-online" };</script>'; 
            $CVK_additionals_text = "Urdu";
            $CVK_additionals_url = "http://loderi.com/urdu-virtual-keyboard-online";
            break;  
        default: echo '<script> var CVK_langStringArray = {
    name: "English", keys: [ 
          ["\u2018", "\u007E", "\u00B0"], ["1", "!", "\u00B1"], ["2", "\u0040", "\u00BC"], ["3", "\u0023", "\u00BD"], ["4", "\u0024", "\u00BE"], ["5", "%", "\u00A4"], ["6", "\u005E", "\u00AC"], ["7", "\u0026", "\u00B2"], ["8", "*", "\u00B3"], ["9", "(", "\u00A2"], ["0", ")", "\u20AC"], ["-", "_", "\u00A3"], ["=", "+", "\u20BD"], 
      ["\u0040", "\u0040", "\u0040"], ["q", "Q", "\u007E"], ["w", "W", "\u00A7"], ["e", "E", "\u00B6"], ["r", "R", ":"], ["t", "T", ";"], ["y", "Y", ""], ["u", "U", "\u0027"], ["i", "I", "\u0022"], ["o", "O", "\u00AB"], ["p", "P", "\u00BB"], ["\u005B", "\u007B", "\u005B"], ["\u005D", "\u007D", "\u005D"], ["\u005C", "\u007C", "\u007B"], ["\u201C", "\u201F", "\u007D"], 
      ["a", "A","\u00B5"], ["s", "S", ""], ["d", "D", ""], ["f", "F", ""], ["g", "G", "\u02BB"], ["h", "H", "\u02BC"], ["j", "J", "„"], ["k", "K", "\u201E"], ["l", "L", "\u201C"], [";", ":", ""], ["\u0027", "\u0022", "!"], ["!", "?", "?"],
      ...
      <div class="CVK_keyboard_popup">
        ...
        <div class="CVK_virtual_keyboard">
            ...
            <div class="CVK_virt_keyboard_line">
                ...
                <span class="CVK_keyboard_button '; if ($CVK_optional1 != "") { echo $CVK_optional1; } else { echo 'CVK_main_buttons';} echo'" data-main="24"></span>            
                <span class="CVK_keyboard_button '; if ($CVK_optional2 != "") { echo $CVK_optional2; } else { echo 'CVK_main_buttons';} echo'" data-main="25"></span>            
            ...
            <div class="CVK_virt_keyboard_line">
                ...
                <span class="CVK_keyboard_button '; if ($CVK_optional3 != "") { echo $CVK_optional3; } else { echo 'CVK_main_buttons'; } echo'" data-main="38"></span>            
